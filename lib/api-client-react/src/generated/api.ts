...
/**
 * @summary Buy a ticket for a game
 */
export const buyTicket = async (id: number, options?: RequestInit): Promise<Ticket> => {
...
export const getBuyTicketMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof buyTicket>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof buyTicket>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof buyTicket>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  buyTicket(id,requestOptions)
        }
